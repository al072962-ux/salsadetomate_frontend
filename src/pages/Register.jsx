      ...
      <header className="relative z-50 w-full h-24 bg-[#ffb800] px-8 flex justify-between items-center flex-shrink-0 shadow-[0_2px_10px_rgba(0,0,0,0.1)]">
        <div className="max-w-7xl mx-auto w-full flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <Link to="/login" className="px-6 py-2 bg-transparent text-white font-bold rounded-full border border-white hover:bg-white/10 shadow-sm transition">
              Ingresar
            </Link>
            <Link to="/register" className="px-6 py-2 bg-white text-[#ffb800] font-bold rounded-full shadow-sm hover:bg-gray-50 transition">
              Regístrate
            </Link>
          </div>
        </div>
